...
const file_pluginapi_v1_cty_proto_rawDesc = "" +
	"\n" +
	"\x16pluginapi/v1/cty.proto\x12\fpluginapi.v1\x1a\x17pluginapi/v1/data.proto\"\x8d\t\n" +
	"\x03Cty\x12;\n" +
	"\tprimitive\x18\x01 \x01(\v2\x1b.pluginapi.v1.Cty.PrimitiveH\x00R\tprimitive\x122\n" +
	"\x06object\x18\x02 \x01(\v2\x18.pluginapi.v1.Cty.ObjectH\x00R\x06object\x12-\n" +
	"\x03map\x18\x03 \x01(\v2\x19.pluginapi.v1.Cty.MappingH\x00R\x03map\x120\n" +
	"\x04list\x18\x04 \x01(\v2\x1a.pluginapi.v1.Cty.SequenceH\x00R\x04list\x12.\n" +
	"\x03set\x18\x05 \x01(\v2\x1a.pluginapi.v1.Cty.SequenceH\x00R\x03set\x122\n" +
	"\x05tuple\x18\x06 \x01(\v2\x1a.pluginapi.v1.Cty.SequenceH\x00R\x05tuple\x12+\n" +
	"\x04null\x18\a \x01(\v2\x15.pluginapi.v1.CtyTypeH\x00R\x04null\x12/\n" +
	"\x04caps\x18\b \x01(\v2\x19.pluginapi.v1.Cty.CapsuleH\x00R\x04caps\x121\n" +
	"\aunknown\x18\t \x01(\v2\x15.pluginapi.v1.CtyTypeH\x00R\aunknown\x12-\n" +
	"\x03dyn\x18\n" +
	" \x01(\v2\x19.pluginapi.v1.Cty.DynamicH\x00R\x03dyn\x1aO\n" +
	"\tPrimitive\x12\x12\n" +
	"\x03str\x18\x01 \x01(\tH\x00R\x03str\x12\x12\n" +
	"\x03num\x18\x02 \x01(\fH\x00R\x03num\x12\x12\n" +
	"\x03bln\x18\x03 \x01(\bH\x00R\x03blnB\x06\n" +
	"\x04data\x1a\xe3\x01\n" +
	"\x06Object\x126\n" +
	"\x04data\x18\x01 \x03(\v2\".pluginapi.v1.Cty.Object.DataEntryR\x04data\x1aI\n" +
	"\x04Attr\x12%\n" +
	"\x04data\x18\x01 \x01(\v2\x11.pluginapi.v1.CtyR\x04data\x12\x1a\n" +
	"\boptional\x18\x02 \x01(\bR\boptional\x1aV\n" +
	"\tDataEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x123\n" +
	"\x05value\x18\x02 \x01(\v2\x1d.pluginapi.v1.Cty.Object.AttrR\x05value:\x028\x01\x1a\xab\x01\n" +
	"\aMapping\x127\n" +
	"\x04data\x18\x01 \x03(\v2#.pluginapi.v1.Cty.Mapping.DataEntryR\x04data\x12\x1b\n" +
	"\tonly_type\x18\x02 \x01(\bR\bonlyType\x1aJ\n" +
	"\tDataEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12'\n" +
	"\x05value\x18\x02 \x01(\v2\x11.pluginapi.v1.CtyR\x05value:\x028\x01\x1aN\n" +
	"\bSequence\x12%\n" +
	"\x04data\x18\x01 \x03(\v2\x11.pluginapi.v1.CtyR\x04data\x12\x1b\n" +
	"\tonly_type\x18\x02 \x01(\bR\bonlyType\x1aH\n" +
	"\aCapsule\x125\n" +
	"\vplugin_data\x18\x01 \x01(\v2\x12.pluginapi.v1.DataH\x00R\n" +
	"pluginDataB\x06\n" +
	"\x04data\x1a\t\n" +
	"\aDynamicB\x06\n" +
	"\x04data\"0\n" +
	"\aCtyType\x12%\n" +
	"\x04type\x18\x01 \x01(\v2\x11.pluginapi.v1.CtyR\x04type\"3\n" +
	"\bCtyValue\x12'\n" +
	"\x05value\x18\x01 \x01(\v2\x11.pluginapi.v1.CtyR\x05valueB\xb6\x01\n" +
	"\x10com.pluginapi.v1B\bCtyProtoP\x01ZGgithub.com/blackstork-io/blackstork-cli/plugin/pluginapi/v1;pluginapiv1\xa2\x02\x03PXX\xaa\x02\fPluginapi.V1\xca\x02\fPluginapi\\V1\xe2\x02\x18Pluginapi\\V1\\GPBMetadata\xea\x02\rPluginapi::V1b\x06proto3"

var (
	file_pluginapi_v1_cty_proto_rawDescOnce sync.Once
	file_pluginapi_v1_cty_proto_rawDescData []byte
)

func file_pluginapi_v1_cty_proto_rawDescGZIP() []byte {
	file_pluginapi_v1_cty_proto_rawDescOnce.Do(func() {
		file_pluginapi_v1_cty_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_pluginapi_v1_cty_proto_rawDesc), len(file_pluginapi_v1_cty_proto_rawDesc)))
	})
...
func file_pluginapi_v1_cty_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_pluginapi_v1_cty_proto_rawDesc), len(file_pluginapi_v1_cty_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   12,
			NumExtensions: 0,
			NumServices:   0,
