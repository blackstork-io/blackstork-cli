...
func (UnimplementedPluginServiceServer) RetrieveData(context.Context, *RetrieveDataRequest) (*RetrieveDataResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method RetrieveData not implemented")
}
func (UnimplementedPluginServiceServer) ProvideContent(context.Context, *ProvideContentRequest) (*ProvideContentResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ProvideContent not implemented")
}
func (UnimplementedPluginServiceServer) FormatContent(context.Context, *FormatContentRequest) (*FormatContentResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method FormatContent not implemented")
}
